...
export default function SinglePost(){
    ...
    return(<>
        <div className='single-post grid grid-cols-2 gap-4 px-14 mt-20 mb-16 w-full'>
            <div className='post-text pb-10 pr-14'>
                <h1 className='text-5xl font-bold mb-3 pb-4'>{post.title}</h1>
                <p className='mb-4 text-gray-500'>Subheading...</p>
                <p className='text-lg'>{post.body}</p>
            </div>
            <div className='post-image pb-20 pl-14'>
